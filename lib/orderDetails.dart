    ...
    ItemService().getOrder(globals.token, id).then((data) {
      if (data != null) {
        setState(() {
          ...
          supplier = data.data['data']['supplier'] != null
              ? data.data['data']['supplier']
              : '';
          referenceNo = data.data['data']['referenceNumber'] != null
              ? data.data['data']['referenceNumber']
              : '';
          deliveryDetails = data.data['data']['deliveryDetails'] != null
              ? data.data['data']['deliveryDetails']
              : '';
